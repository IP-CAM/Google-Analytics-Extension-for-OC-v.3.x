...
$_['heading_getting_started']      = 'Začátek';
$_['heading_setup']                = 'Nastavení Google Analytics (GA4)';
...
$_['text_contact']                  = '<p>Pro další pomoc se prosím obraťte na náš tým podpory:</p><ul><li><strong>Kontakt:</strong> <a href="mailto:%s">%s</a></li><li><strong>Dokumentace:</strong> <a href="https://github.com/playfulsparkle/oc4_google_analytics" target="_blank" rel="noopener noreferrer">Dokumentace pro uživatele</a></li></ul>';
