...
$_['text_contact']                  = '<p>Für weitere Unterstützung kontaktieren Sie bitte unser Support-Team:</p><ul><li><strong>Kontakt:</strong> <a href="mailto:%s">%s</a></li><li><strong>Dokumentation:</strong> <a href="https://github.com/playfulsparkle/oc4_google_analytics" target="_blank" rel="noopener noreferrer">Benutzerdokumentation</a></li></ul>';
