...
$_['heading_setup']                = 'Einrichten von Google Analytics (GA4)';
$_['heading_troubleshot']          = 'Häufige Probleme';
...
$_['text_getting_started']          = '<p><strong>Überblick:</strong> Die Playful Sparkle - Google Analytics (GA4) Erweiterung für OpenCart 3.x ermöglicht Ihnen die einfache Integration des Google Analytics (GA4) Trackings in Ihren OpenCart-Shop, ohne dass Programmierkenntnisse erforderlich sind.</p><p><strong>Voraussetzungen:</strong> Stellen Sie sicher, dass Sie ein Google Analytics-Konto, eine gültige Google Tag-ID haben und dass Sie eine kompatible Version von OpenCart 3.x+, PHP 7.3 verwenden.</p>';
