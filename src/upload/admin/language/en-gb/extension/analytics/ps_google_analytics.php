...
$_['text_contact']                  = '<p>For further assistance, please reach out to our support team:</p><ul><li><strong>Contact:</strong> <a href="mailto:%s">%s</a></li><li><strong>Documentation:</strong> <a href="https://github.com/playfulsparkle/oc4_google_analytics" target="_blank" rel="noopener noreferrer">User Documentation</a></li></ul>';
